...
const getConfig = (prefix) => ({
  index: `<script src="js/${
    prefix ? getManifest(`index${prefix}.js`) : "index.js"
  }"></script>`,
  bot: `<script src="js/${
    prefix ? getManifest(`bot${prefix}.js`) : "bot.js"
  }"></script>`,
  bundle: `<script src="js/${getManifest("bundle.js")}"></script>`,
  bundle_css: `<link href="css/${getManifest(
    "bundle.css"
  )}" rel="stylesheet" />`,
  index_css: `<link href="css/${getManifest("index.css")}" rel="stylesheet" />`,
  bot_css: `<link href="css/${getManifest("bot.css")}" rel="stylesheet" />`,
  theme_css: `<link href="css/${getManifest("theme.css")}" rel="stylesheet" />`,
